...
<body class="font-poppins antialiased">
    ...
    <img src="{{ asset('img/logo.svg')}}" width="150px" alt="Logo" />
        </div>
          ...
          <div id="menu" class="flex flex-col space-y-2">
            ...
            >
              ...
              <span class="">Ver solicitudes de permisos</span>
            </a>
            <a
              href="{{ route ('cadenas') }}"
            ...
            >
              ...
              <span class="">Ver solicitudes de cadenas </span>
            </a>
            <a
              href="{{ route ('canasta') }}"
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
            >
              ...
              <span class="">Ver solicitudes de canasta</span>
            </a>
            <a
            href="{{ route ('solicitud') }}"
            class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
          >
            <svg
              class="w-6 h-6 fill-current inline-block"
            ...
            <span class="">Ver solicitudes de exentacion de pago</span>
          </a>
          <a
        ...
        >
          ...
          <span class="">Ver solicitudes de descuentos</span>
        </a>
            <br><br><br>
            <div class="d-flex justify-content-center">
             <a class="btn btn-sm" href="" role="button" style="background-color: #B11830; border-color: #B11830; color: #fff;">Cerrar sesión</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
      ...
      <script type="module">
        ...
        const firebaseConfig = {
          apiKey: "AIzaSyCgIC7o0_cWEGAzefRBI05CBuwIwQLT-r4",
          authDomain: "administrativoujed.firebaseapp.com",
          projectId: "administrativoujed",
          storageBucket: "administrativoujed.appspot.com",
          messagingSenderId: "561278340254",
          appId: "1:561278340254:web:c50ac0f595e334d8e4ff8f",
          measurementId: "G-20FBWCQW53"
        };
